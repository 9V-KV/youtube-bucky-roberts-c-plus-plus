...
int main() {
	...
	cout << "Method 1, The size of one element in the array: " << sizeof(array[0]) << endl;
	cout << "Method 2, The size of one element in the array: " << sizeof(array) / sizeof(array[0])<< endl;
